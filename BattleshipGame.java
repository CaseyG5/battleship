...
//}
//
//class ShootMessage extends Message implements Serializable {
//    int r, c;    // row, column
//    
//    ShootMessage(int r, int c)
//    {   type = "s";   this.r = r;   this.c = c;   }
//}
//
//class ResultMessage extends Message implements Serializable {
//    boolean hom;    // hit or miss?
//    
//    ResultMessage(boolean h)
//    {   type = "r";   hom = h;   }
//}
...
/*if(evt.getComponent().getBackground().equals(ocean))
                evt.getComponent().setBackground(Color.DARK_GRAY);
            else if(evt.getComponent().getBackground().equals(Color.DARK_GRAY))
                evt.getComponent().setBackground(Color.RED);
            else if(evt.getComponent().getBackground().equals(Color.RED))
                evt.getComponent().setBackground(ocean);
*/

//            textOut.append("You clicked on: " + (char) (yCoord + 65) + "-" 
//                    + (25 - xCoord) + "\n");